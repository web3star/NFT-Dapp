// SPDX-License-Identifier: MIT
  ...
  contract CryptoDevs is ERC721Enumerable, Ownable {
       ...
       * name in our case is `Web3 Stars` and symbol is `CD`.
       * Constructor for Web3 Stars takes in the baseURI to set _baseTokenURI for the collection.
       * It also initializes an instance of whitelist interface.
       */
      constructor (string memory baseURI, address whitelistContract) ERC721("Web3 Stars", "WS") {
